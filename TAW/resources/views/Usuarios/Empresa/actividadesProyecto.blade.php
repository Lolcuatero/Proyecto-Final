      ...
      <div class="col-md-12">
        <div>
          <a href="#ventana1" data-toggle="modal" class="btn btn-sm btn-primary waves-effect waves-light f-right">
                                        ...
                                        Crear Tarea</a>
          <a href="#ventana2" data-toggle="modal" class="btn btn-sm btn-warning waves-effect waves-light f-left"><i class="icofont icofont-edit"></i>Marcar Proyecto como Terminado</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="card-block">
    ...
    <div class="text-right">
      <?php if($tarea->estado=='Finalizada')
            ...
            { ?>
            <a href="/Finalizar/Tarea/{{$tarea->id}}" class="btn btn-success ">¿Tarea Finalizada?</a>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="fecha" placeholder="Fecha" id="user" required>
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea rows="15" cols="50" class="form-control" placeholder="Comentario" name="comentario" id="Descripcion" required></textarea>
                </div>
              </div>
            </div>
            <div class="row">
